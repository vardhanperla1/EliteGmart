                ...
                <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                    ...
                    <div class="col-auto">
                        <div class="header-links">
                            <ul>
                                <li class="d-none d-sm-inline-block"><i class="fal fa-location-dot"></i><a href="https://www.google.com/maps">Hyderabad</a></li>
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                ...
                                <a href="index.html" class="th-btn style4">Shop Now<i class="fas fa-chevrons-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <input type="hidden" id="status" value="<%= request.getAttribute("status") %>"> 
    <div class="th-checkout-wrapper space-top space-extra-bottom">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="register" class="woocommerce-form-login">
                       
                        <div class="form-group">
                             <label>Username or email *</label>
                        <input type="text" class="form-control" name="username" id="username" placeholder="Username or email" required="required">
                       
                    </div>
                        
                        <div class="form-group">
                            <label>Phone Number *</label>
                        <input type="tel" class="form-control" name="number" id="number" placeholder="Phone Number" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="re_pass" id="re_pass" placeholder="Confirm password" required="required">
                        </div>
                        <div>
                            <label for="referredBy">Referred By (Referral Code):</label><br>
                            <input type="text" id="referredBy" name="referredBy"><br><br>
                        </div>
                        
                        <div class="form-group d-flex align-items-center">
                            <button type="submit" class="th-btn">Register</button>
<p class="mx-5 mb-0"><a class="text-reset" href="login.jsp">Login</a></p>
                        </div>
                    </form>
                </div>
            </div>
